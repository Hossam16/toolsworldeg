...
class ClubPointController extends Controller
{
    ...
    {
        $club_point_convert_rate = getBusinessSetting()->where('type', $request->type)->first();
    ...
    {
        $club_point_convert_rate = getBusinessSetting()->where('type', 'club_point_convert_rate')->first()->value;
