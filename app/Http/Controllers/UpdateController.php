...
class UpdateController extends Controller
{
    ...
    public function step1() {
        if(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.7'){
            $sql_path = base_path('sqlupdates/v38.sql');
            DB::unprepared(file_get_contents($sql_path));

            return redirect()->route('update.step2');
        }
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.6'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.5'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.4'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.3'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.2'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.1'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '3.0'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.9'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.8'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.7'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.6'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.5'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.4'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.3'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.2'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.1'){
        ...
        elseif(getBusinessSetting()->where('type', 'current_version')->first() != null && getBusinessSetting()->where('type', 'current_version')->first()->value == '2.0'){
    ...
    public function convertAssetsToUploader(){
        ...
        $business_setting = getBusinessSetting()->where('type', 'home_slider_images')->first();
        $business_setting->value = json_encode(Slider::pluck('photo')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_slider_links')->first();
        $business_setting->value = json_encode(Slider::pluck('link')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_banner1_images')->first();
        $business_setting->value = json_encode(Banner::where('position', 1)->pluck('photo')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_banner1_links')->first();
        $business_setting->value = json_encode(Banner::where('position', 1)->pluck('url')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_banner2_images')->first();
        $business_setting->value = json_encode(Banner::where('position', 2)->pluck('photo')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_banner2_links')->first();
        $business_setting->value = json_encode(Banner::where('position', 2)->pluck('url')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'home_categories')->first();
        $business_setting->value = json_encode(HomeCategory::pluck('category_id')->toArray());
        $business_setting->save();

        $business_setting = getBusinessSetting()->where('type', 'top10_categories')->first();
