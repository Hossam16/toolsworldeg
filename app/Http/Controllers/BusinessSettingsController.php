...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', $request->payment_method.'_sandbox')->first();
    ...
    public function google_analytics_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', 'google_analytics')->first();
    ...
    public function google_recaptcha_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', 'google_recaptcha')->first();
    ...
    public function facebook_chat_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', 'facebook_chat')->first();
    ...
    public function facebook_pixel_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', 'facebook_pixel')->first();
    ...
    public function seller_verification_form_update(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', 'verification_form')->first();
    ...
    public function update(Request $request)
    {
        foreach ($request->types as $key => $type) {
            ...
            if($type == 'timezone'){
                ...
                $business_settings = getBusinessSetting()->where('type', $type)->first();
                if($business_settings!=null){
    ...
    public function updateActivationSettings(Request $request)
    {
        ...
        $business_settings = getBusinessSetting()->where('type', $request->type)->first();
        if($business_settings!=null){
    ...
    {
        $business_settings = getBusinessSetting()->where('type', 'vendor_commission')->first();
