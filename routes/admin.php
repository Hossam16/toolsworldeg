...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::resource('addprice','AddpriceController');
	Route::get('/addprice/edit/{id}', 'AddpriceController@edit')->name('Addprice.edit');
	
	Route::post('/addprice/store', 'AddpriceController@update')->name('Addprice.update');
...
//	Route::post('/notification/test/smtp', 'notificationController@testEmail')->name('notification.smtp');
