    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_bulk_update.index') }}" class="aiz-side-nav-link" >
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Cashier') }}</span>
                                </a>
                            </li>
                          <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
							 ...
							 <li class="aiz-side-nav-item">
                                <a href="{{route('addprice.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['addprice.index', 'addprice.create', 'addprice.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('ChangePrice')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                ...
                <!-- Refund addon -->
                @if (getAddons()->where('unique_identifier', 'refund_request')->first() != null && getAddons()->where('unique_identifier', 'refund_request')->first()->activated)
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @if(getBusinessSetting()->where('type', 'classified_product')->first()->value == 1)
                            <li class="aiz-side-nav-item">
                ...
                <!-- Sellers -->
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && getBusinessSetting()->where('type', 'vendor_system_activation')->first()->value == 1)
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                           ...
                           <li class="aiz-side-nav-item">
                                    <a href="{{route('notification.index')}}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Notifications') }}</span>
                                    </a>
                                </li>
