		                ...
		                @foreach($brands as $key => $brand)
		                    <tr>
		                        ...
		                        <td class="text-right">
									...
									<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('Addprice.edit', ['id'=>$brand->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="تغيير السعر">
                                <i class="las la-bitcoin"></i>
                            </a>
