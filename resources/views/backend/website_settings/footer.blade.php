    			                ...
    			                <div class="form-group">
    								...
    								<div class="w3-links-target">
    									...
    									@if (get_setting('widget_one_labels') != null)
    										@foreach (json_decode(App\getBusinessSetting()->where('type', 'widget_one_labels')->first()->value, true) as $key => $value)
    											<div class="row gutters-5">
    												...
    												<div class="col">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="http://" name="widget_one_links[]" value="{{ json_decode(App\getBusinessSetting()->where('type', 'widget_one_links')->first()->value, true)[$key] }}">
    													</div>
    												</div>
    												<div class="col-auto">
