...
@if (getBusinessSetting()->where('type', 'voguepay_sandbox')->first()->value == 1)
...
<script>
        ...
        function pay3() {
         Voguepay.init({
             ...
             cur: '{{getCurrencies()->where("id",getBusinessSetting()->where('type', 'system_default_currency')->first()->value)->first()->code}}',
             merchant_ref: 'ref123',
