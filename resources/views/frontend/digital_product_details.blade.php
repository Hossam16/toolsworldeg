                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    @if ($detailedProduct->added_by == 'seller' && getBusinessSetting()->where('type', 'vendor_system_activation')->first()->value == 1)
                                        <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}" class="text-reset">{{ $detailedProduct->user->shop->name }}</a>
                                    @else
                                        {{  translate('Inhouse product') }}
                                    @endif
                                </div>
                                @if (getBusinessSetting()->where('type', 'conversation_system')->first()->value == 1)
                                    <div class="col-auto">
                            ...
                            @if (getAddons()->where('unique_identifier', 'club_point')->first() != null && getAddons()->where('unique_identifier', 'club_point')->first()->activated && $detailedProduct->earn_point > 0)
                            ...
                            @php
                                ...
                                $refund_sticker = getBusinessSetting()->where('type', 'refund_sticker')->first();
                            @endphp
                ...
                <div class="col-xl-3">
                    <div class="bg-white shadow-sm mb-3">
                        <div class="position-relative p-3 text-left">
                            @if ($detailedProduct->added_by == 'seller' && getBusinessSetting()->where('type', 'vendor_system_activation')->first()->value == 1 && $detailedProduct->user->seller->verification_status == 1)
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        @if(getBusinessSetting()->where('type', 'google_login')->first()->value == 1 || getBusinessSetting()->where('type', 'facebook_login')->first()->value == 1 || getBusinessSetting()->where('type', 'twitter_login')->first()->value == 1)
                            <div class="separator mb-3">
                                <span class="bg-white px-3 opacity-60">{{ translate('Or Login With')}}</span>
                            </div>
                            <ul class="list-inline social colored text-center mb-5">
                                @if (getBusinessSetting()->where('type', 'facebook_login')->first()->value == 1)
                                    <li class="list-inline-item">
                                ...
                                @endif
                                @if(getBusinessSetting()->where('type', 'google_login')->first()->value == 1)
                                    <li class="list-inline-item">
                                ...
                                @endif
                                @if (getBusinessSetting()->where('type', 'twitter_login')->first()->value == 1)
                                    <li class="list-inline-item">
