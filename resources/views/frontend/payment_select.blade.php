                ...
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                    ...
                    <div class="card shadow-sm border-0 rounded">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        @if(getBusinessSetting()->where('type', 'paypal_payment')->first()->value == 1)
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'PAYMOB')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="PAYMOB" class="online_payment" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="https://accept.paymob.com/static/img/paymob_new.svg" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">PAYMOB</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        @endif
                                    @if(getBusinessSetting()->where('type', 'stripe_payment')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'sslcommerz_payment')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'instamojo_payment')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'razorpay')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'paystack')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'voguepay')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'payhere')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'ngenius')->first()->value == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @if(getAddons()->where('unique_identifier', 'african_pg')->first() != null && getAddons()->where('unique_identifier', 'african_pg')->first()->activated)
                                            ...
                                            @endif
                                            @if(getBusinessSetting()->where('type', 'flutterwave')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                            ...
                                            @endif
                                            @if(getBusinessSetting()->where('type', 'payfast')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                        ...
                                        @endif
                                        @if(getBusinessSetting()->where('type', 'cash_payment')->first()->value == 1)
                                            @php
                                                $digital = 0;
                            ...
                            @endif
                            @if (Auth::check() && getBusinessSetting()->where('type', 'wallet_system')->first()->value == 1)
