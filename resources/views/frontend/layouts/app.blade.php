...
<head>
    ...
    <meta name="google-site-verification" content="MLkLW4EKhx_ib8dG4EDJ4ajmTiwFbmd399dlxldCGw8" />
    ...
    @endif
    <link rel="stylesheet" href="{{ static_asset('assets/css/aiz-core.css?1') }}">
...
@if (getBusinessSetting()->where('type', 'google_analytics')->first()->value == 1)
...
@if (getBusinessSetting()->where('type', 'facebook_pixel')->first()->value == 1)
    <!-- Facebook Pixel Code -->
    <script>
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        <div class="whatsapp-icon">
            <a href="https://wa.me/+201030007113" target="_blank">
                <img src="{{ static_asset('assets/img/whatsapp-icon.png') }}" style="width:60px" alt="WhatsApp Icon">
            </a>
        </div>
...
<script>
    // This code can be used to toggle the visibility of the WhatsApp icon
