                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                ...
                                                @if (getCachedCategories()->find($category_id)->parent_id != 0)
                                                    <li class="mb-2">
                                                        <a class="text-reset fs-14 fw-600" href="{{ route('customer_products.category', getCachedCategories()->find(getCachedCategories()->find($category_id)->parent_id)->slug) }}">
                                                            <i class="las la-angle-left"></i>
                                                ...
                                                @endif
                                                <li class="mb-2">
                                                    <a class="text-reset fs-14 fw-600" href="{{ route('customer_products.category', getCachedCategories()->find($category_id)->slug) }}">
                                                        <i class="las la-angle-left"></i>
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-4 mb-2">
                                                        <a class="text-reset fs-14" href="{{ route('customer_products.category', getCachedCategories()->find($id)->slug) }}">{{ getCachedCategories()->find($id)->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
                        ...
                        <ul class="breadcrumb bg-transparent p-0">
                            ...
                            @if(isset($category_id))
                                <li class="text-dark fw-600 breadcrumb-item">
                                    <a class="text-reset" href="{{ route('customer_products.category', getCachedCategories()->find($category_id)->slug) }}">"{{ getCachedCategories()->find($category_id)->getTranslation('name') }}"</a>
                                </li>
                            @endif
                        </ul>

                        @isset($category_id)
                            <input type="hidden" name="category" value="{{ getCachedCategories()->find($category_id)->slug }}">
                        @endisset
                        <div class="text-left">
                            <div class="d-flex">
